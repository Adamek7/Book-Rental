...
public class Application {
    ...
    public static void main(String[] args) {
        //staticFiles.externalLocation(System.getProperty("user.dir") + "/src/main/resources/Views"); //statyczny folder z plikami velocity
        externalStaticFileLocation(System.getProperty("user.dir") + "/src/main/resources/Views");
        port(8000);
        init();
